...
ALTER TABLE "Review_Post" ADD CONSTRAINT "FK_Members_TO_Review_Post_1" FOREIGN KEY (
	"UID"
)
REFERENCES "Members" (
	"UID"
...
ALTER TABLE "Cal_Post" ADD CONSTRAINT "FK_Members_TO_Cal_Post_1" FOREIGN KEY (
	"UID"
)
REFERENCES "Members" (
	"UID"
...
ALTER TABLE "Reading_Info" ADD CONSTRAINT "FK_Members_TO_Reading_Info_1" FOREIGN KEY (
	"UID"
)
REFERENCES "Members" (
	"UID"
